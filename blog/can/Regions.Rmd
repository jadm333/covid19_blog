...
write.csv(central$temp,file = "Central.csv")
write.csv(east$temp,file = "East.csv")
write.csv(north$temp,file = "North.csv")
write.csv(toronto$temp,file = "Toronto.csv")
write.csv(west$temp,file = "West.csv")
```
